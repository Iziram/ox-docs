...
export function Footer() {
  return (
    <footer className="border-fd-border border-t bg-fd-background/50 backdrop-blur">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            <h4 className="mb-4 font-semibold text-fd-foreground">Resources</h4>
            <ul className="space-y-2">
              <li>
                <a
                  ...
                  className="text-fd-muted-foreground text-sm transition-colors hover:text-fd-primary"
                >
                  GitHub
                </a>
              </li>
          ...
          <div>
            <h4 className="mb-4 font-semibold text-fd-foreground">Community</h4>
            <ul className="space-y-2">
              <li>
                <a
                  href="https://discord.gg/qng8eEuP2q"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-fd-muted-foreground text-sm transition-colors hover:text-fd-primary"
                >
              ...
              <li>
                <a
                  href="https://github.com/tonybanters/oxwm/discussions"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-fd-muted-foreground text-sm transition-colors hover:text-fd-primary"
                >
          ...
          <div>
            <h4 className="mb-4 font-semibold text-fd-foreground">Connect</h4>
        ...
        <div className="border-fd-border border-t pt-8 text-center text-fd-muted-foreground text-sm">
          <p>
            Inspired by{" "}
            <a
